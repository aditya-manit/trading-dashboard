...
- **The drawer header "This week's high-impact" is a `HoverTip`** explaining the filter (`FILTER_TIP`): high-impact USD releases + non-USD central-bank decisions, with minor-currency data hidden — i.e. a plain-English description of `isBtcRelevant`.
