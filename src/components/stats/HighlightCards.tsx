...
const SVG_TROPHY = "url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22240%22%20height=%22150%22%3E%3Cg%20transform=%22translate(150,46)%20scale(5)%22%20fill=%22none%22%20stroke=%22%23c79a3e%22%20stroke-width=%220.55%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22%20opacity=%220.24%22%3E%3Cpath%20d=%22M6%209H4.5a2.5%202.5%200%200%201%200-5H6%22/%3E%3Cpath%20d=%22M18%209h1.5a2.5%202.5%200%200%200%200-5H18%22/%3E%3Cpath%20d=%22M4%2022h16%22/%3E%3Cpath%20d=%22M10%2014.66V17c0%20.55-.47.98-.97%201.21C7.85%2018.75%207%2020.24%207%2022%22/%3E%3Cpath%20d=%22M14%2014.66V17c0%20.55.47.98.97%201.21C16.15%2018.75%2017%2020.24%2017%2022%22/%3E%3Cpath%20d=%22M18%202H6v7a6%206%200%200%200%2012%200V2Z%22/%3E%3C/g%3E%3C/svg%3E\") right bottom no-repeat";
...
export function HighlightCards() {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 18 }}>
      ...
      {/* Amber — Win streak — trophy */}
      <div style={{ ...CARD_STYLE, background: `${SVG_TROPHY},${SHEEN},linear-gradient(140deg,#fff6e6,#ffeccb)` }}>
        <span style={{ fontWeight: 600, fontSize: 12.5, color: '#9a7522' }}>Best win streak</span>
        <div>
          <div style={{ fontWeight: 800, fontSize: 27, letterSpacing: '-0.02em', color: '#5b4416' }}>
            {stats.winStreak ? `${stats.winStreak.count} trades` : '—'}
          </div>
          <span style={{ fontWeight: 600, fontSize: 12.5, color: '#a8893f' }}>
