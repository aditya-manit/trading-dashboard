      ...
      <div style={{ background: 'linear-gradient(180deg,#f7f3ff,#ffffff 42%)', border: '1px solid #e3d8f8', borderRadius: 20, padding: '24px 26px 14px', boxShadow: '0 12px 32px rgba(110,80,210,0.13)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 12, marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
            ...
            <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, fontWeight: 700, fontSize: 10.5, letterSpacing: '0.07em', color: '#6a45c4', background: '#efe9fd', padding: '4px 10px', borderRadius: 20 }}>LIVE</span>
          </div>
